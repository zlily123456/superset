...
exports.withTooltipPropTypes = exports.Tooltip = undefined;
...
var propTypes = _extends({}, _TooltipWithBounds.withTooltipPropTypes, {
  ...
  _createClass(WithTooltip, [{
    ...
    value: function handleMouseMove(_ref) {
      var event = _ref.event,
          datum = _ref.datum,
          rest = _objectWithoutProperties(_ref, ['event', 'datum']);
      ...
      if (event && event.target && event.target.ownerSVGElement) {
        coords = (0, _localPoint2.default)(event.target.ownerSVGElement, event);
      }
