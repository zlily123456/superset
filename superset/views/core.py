...
class Superset(BaseSupersetView):
    ...
    def explore(self, datasource_type, datasource_id):
        ...
        print("view.core.py-->q1q1q1")
        print(datasource_id)
        print(type(datasource_id))
        print("view.core.py-->q2q2q2")
        print(app.url_map)
        print('view.core.py-->q8q8q8')
        print(app.view_functions)
        print('view.core.py-->q9q9q9')
       ...
       # print("view.core.py-->q3q3q3")
        ...
        print(type(datasource.data))
        print("view.core.py-->q4q4q4")    
        if not datasource:
