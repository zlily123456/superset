...
<html lang="en">
<head>
    <title>Code coverage report for src/chart/RadialChart.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/chart</a> RadialChart.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (innerWidth &lt; 10 || innerHeight &lt; 10) <span class="cstat-no" title="statement not covered" >return null;</span>
&nbsp;
  return (
    &lt;svg
