...
<html lang="en">
<head>
    <title>Code coverage report for src/components/SubTree.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/components</a> SubTree.jsx
    </h1>
    <div class='clearfix'>
...
const defaultProps = {
  ...
  onMouseOut: <span class="fstat-no" title="function not covered" >()</span> =&gt; {},
...
&nbsp;
<span class="fstat-no" title="function not covered" >  on</span>MouseOver(event) {
    const target = <span class="cstat-no" title="statement not covered" >event.target;</span>
    const { node, link } = <span class="cstat-no" title="statement not covered" >this.getNodeFromTarget(target);</span>
<span class="cstat-no" title="statement not covered" >    if (node || link) {</span>
      const coords = <span class="cstat-no" title="statement not covered" >getCoordsFromEvent(target, event);</span>
<span class="cstat-no" title="statement not covered" >      this.props.onMouseOver({ node, link, coords, event });</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  on</span>MouseOut() {
<span class="cstat-no" title="statement not covered" >    this.props.onMouseOut();</span>
  }
&nbsp;
  onClickNode(event) {
...
&nbsp;
  getNodeFromTarget(target) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (target) {
      ...
      const group = hasDataAttr ? target : <span class="branch-1 cbranch-no" title="branch not covered" >target.parentElement;</span>
      if (group &amp;&amp; group.attributes['data-node']) {
        result.node = nodes[group.attributes['data-node'].value];
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (group &amp;&amp; group.attributes['data-target']) {
            ...
            &lt;Group key={node.id} style={{ cursor: 'pointer' }}&gt;
              ...
              {hasParent &amp;&amp;
                &lt;Link
                  source={node.parent}
                  target={node}
                  x={Math.min(left, parentLeft) + (left &gt; parentLeft ? DEFAULT_NODE_WIDTH : <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>}
                  y={top}
