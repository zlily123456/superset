...
<html lang="en">
<head>
    <title>Code coverage report for src/series/ArcSeries.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/series</a> ArcSeries.jsx
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Arc } from '@vx/shape';
...
const defaultProps = {
  ...
  cornerRadius: 3,
  fill: arc =&gt; (
    (arc.data &amp;&amp; arc.data.label) ? <span class="branch-0 cbranch-no" title="branch not covered" >grayScale(arc.data.label) </span>: '#dddddd'
  ),
  fillOpacity: 1,
  stroke: '#ffffff',
  strokeWidth: 1,
      ...
      {label &amp;&amp; labelComponent &amp;&amp;
        &lt;Arc
          ...
          centroid={(centroid, arc) =&gt; {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (arc.endAngle - arc.startAngle &lt; 0.1 || !labelElement) <span class="cstat-no" title="statement not covered" >return null;</span>
