...
<html lang="en">
<head>
    <title>Code coverage report for src/enhancer/WithTooltip.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/enhancer</a> WithTooltip.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  handleMouseMove({ event, datum, ...rest }) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.tooltipTimeout) <span class="cstat-no" title="statement not covered" >clearTimeout(this.tooltipTimeout);</span>
&nbsp;
    let coords = { x: 0, y: 0 };
    <span class="missing-if-branch" title="if path not taken" >I</span>if (event &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >event.target </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >event.target.ownerSVGElement)</span> {
<span class="cstat-no" title="statement not covered" >      coords = localPoint(event.target.ownerSVGElement, event);</span>
    }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Aug 18 2017 15:26:18 GMT-0700 (PDT)
</div>
</div>
